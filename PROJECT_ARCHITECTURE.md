...
- **AI Engine**: LangChain constructs `SystemMessage`, historical `AIMessage`/`HumanMessage` context, and streams calls to OpenRouter (`meta-llama/llama-3.3-70b-instruct:free`).
